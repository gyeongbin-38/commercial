  ...
  return (
    <footer className="wk-dark-section overflow-hidden">
      <div className="wk-container relative py-16 min-[900px]:py-24">
        {/* Ambient floating thumbnails behind the CTA — last-impression
            motion, desktop only */}
        <div
          aria-hidden="true"
        ...
        >
          {[
            { p: WORK_PROJECTS[0], x: "left-6", y: "top-0", w: 200, d: "0s", r: "-5deg" },
            { p: WORK_PROJECTS[3], x: "right-0", y: "top-24", w: 170, d: "1.4s", r: "4deg" },
            { p: WORK_PROJECTS[1], x: "left-24", y: "top-52", w: 150, d: "2.6s", r: "-3deg" },
          ].map(({ p, x, y, w, d, r }) => (
            <div
              key={p.id}
            ...
            >
              <div className="wk-collage-float" style={{ animationDelay: d }}>
                <img
                  src={p.screenshot}
                  alt=""
